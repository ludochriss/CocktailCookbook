...
namespace CocktailCookbook.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,NickName,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,NickName,Email")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
